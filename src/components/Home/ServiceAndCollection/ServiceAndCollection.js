        ...
        <div >
            ...
            <div className="row">
                <div className="col-md-4 p-5" style={{backgroundColor: '#2E3348'}}>
                    <a href="/"><img src="https://i.ibb.co/0MBLqsf/Summer-Autumn.png" alt="" className='w-100'/></a>
                </div>
                <div className="col-md-4 p-5" style={{backgroundColor: '#34394F'}}>
                    <a href="/"><img src="https://i.ibb.co/M2zKsXk/slider-9-1-1.png" alt="" className='w-100'/></a>
                </div>
                <div className="col-md-4 p-5" style={{backgroundColor: '#2E3348'}}>
                    <a href="/"><img src="https://i.ibb.co/nzq5RGc/New-Fashion-Styles.png" alt="" className='w-100'/></a>
                </div>
            </div>
        </div>
    );
